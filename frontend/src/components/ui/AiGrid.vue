                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="Url">{{ val.url }}</td>
                            <td class="whitespace-nowrap" label="Status">{{ val.status }}</td>
                            <td class="whitespace-nowrap" label="이미지생성 ai모델">
                                <DalleId :editMode="editMode" v-model="val.dalleId"></DalleId>
                            </td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="Url" v-model="selectedRow.url" :editMode="true"/>
